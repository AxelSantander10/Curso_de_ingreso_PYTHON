...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self): 
        ...
        alert("resultado",f"La suma entre los numeros es de: {resultado}")

    def btn_restar_on_click(self):
        operador_a = int(self.txt_operador_a.get())
        operador_b = int(self.txt_operador_b.get())
        resultado = operador_a - operador_b 
        alert("resultado",f"La resta entre los numeros es de: {resultado}")

    def btn_multiplicar_on_click(self):
        operador_a = int(self.txt_operador_a.get())
        operador_b = int(self.txt_operador_b.get())
        resultado = operador_a * operador_b 
        alert("resultado",f"La multiplicacion entre los numeros es de: {resultado}")

    def btn_dividir_on_click(self):
        operador_a = float(self.txt_operador_a.get())
        operador_b = float(self.txt_operador_b.get())
        resultado = operador_a / operador_b 
        alert("resultado",f"La division entre los numeros es de: {resultado}")
